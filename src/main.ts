  ...
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        <a href="#" class="logo">
          <img src="/img/logo-280w.avif" srcset="/img/logo-140w.avif 140w, /img/logo-280w.avif 280w" sizes="110px" alt="ZentroSoft - Agencia de Desarrollo Web y Software" width="140" height="40" />
        </a>
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-socials">
        ...
        <a href="https://instagram.com/zentrosoftco" class="footer-social-link" aria-label="Instagram">
        ...
        <a href="https://www.facebook.com/zentroSsoftco/" class="footer-social-link" aria-label="Facebook">f</a>
      </div>
    </div>
  </div>
</footer>
...
<!-- ===== BACK TO TOP ===== -->
<button class="to-top" id="toTop" aria-label="Volver arriba">
  <svg width="18" height="18" viewBox="0 0 16 16" fill="none" aria-hidden="true"><path d="M4 10l4-4 4 4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
</button>
`
